  ...
  return (
    <>
      ...
      <div className="group">
        ...
        <div className="absolute inset-x-0 -top-2.5 -z-10 mt-1 grid grid-cols-2 gap-2.5 border-y px-3.5 py-3 transition-all group-focus-within:top-14 group-focus-within:bg-slate-50/80 group-focus-within:backdrop-blur lg:relative lg:!inset-auto lg:z-auto lg:m-0 lg:flex lg:border-0 lg:bg-transparent lg:p-0 lg:backdrop-blur-0">
          <select
